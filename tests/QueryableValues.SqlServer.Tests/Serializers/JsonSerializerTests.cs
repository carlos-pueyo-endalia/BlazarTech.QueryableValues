...
namespace BlazarTech.QueryableValues.SqlServer.Tests.Serializers
{
    public class JsonSerializerTests
    {
        ...
        [Fact]
        public void IsValidJsonForComplexType()
        {
            ...
            var expectedDateTimeOffset = $@"""E"":""0001-01-01T00:00:00+00:00"",""E1"":""9999-12-31T23:59:59.9999999+00:00"",""E2"":""2021-01-01T01:02:03.004+00:00"",""E3"":""2021-01-01T01:02:03.004+05:30""";
            ...
            var expected = $@"[{{""X"":0,""B"":true,""B1"":false,{expectedByte},{expectedInt16},{expectedInt32},{expectedInt64},{expectedDecimal},{expectedSingle},{expectedDouble},{expectedDateTime},{expectedDateTimeOffset},{expectedGuid},{expectedChar},{expectedString}}}]";
            Assert.Equal(expected, actual);
        }

        [Fact]
        public void IsValidEmptyJsonForComplexType()
        {
            var testType = new
            {
                A = 1
            ...
            var values = new[] { testType };
            var mappings = EntityPropertyMapping.GetMappings(testType.GetType(), typeof(ComplexQueryableValuesEntity));
            var json = _serializer.Serialize(values.Take(0), mappings);
            Assert.Equal("[]", json);
        }
    }
}
